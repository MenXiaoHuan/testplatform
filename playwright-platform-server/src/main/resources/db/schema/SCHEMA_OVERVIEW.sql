-- MySQL bootstrap schema for playwright-platform-server.
-- Usage:
--   mysql -u root -p < SCHEMA_OVERVIEW.sql
--
-- Default database name follows application.yml:
--   playwright_platform

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

CREATE DATABASE IF NOT EXISTS playwright_platform
